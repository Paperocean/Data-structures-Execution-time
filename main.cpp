...
// HASH TABLE
long long timeMeasureHashTableChaining(function<void(HashTableChaining&, int, int)> operation, int value, int key) {
	auto start = chrono::high_resolution_clock::now();
	for (size_t i = 0; i < 1000000; i++) {
...
// HASH TABLE LINEAR
long long timeMeasureHashTableLinear(function<void(HashTableLinear&, int, int)> operation, int value, int key) {
	auto start = chrono::high_resolution_clock::now();
	for (size_t i = 0; i < 1000000; i++) {
...
// HASH TABLE DOUBLE
long long timeMeasureHashTableDouble(function<void(HashTableDouble&, int, int)> operation, int value, int key) {
	auto start = chrono::high_resolution_clock::now();
	for (size_t i = 0; i < 1000000; i++) {
...
// HASH TABLE QUADRIC
long long timeMeasureHashTableQuadric(function<void(HashTableQuadric&, int, int)> operation, int value, int key) {
	auto start = chrono::high_resolution_clock::now();
	for (size_t i = 0; i < 1000000; i++) {
...
long long timeMeasureHashTableRobinHood(function<void(HashTableRobinHood&, int, int)> operation, int value, int key) {
	auto start = chrono::high_resolution_clock::now();
	for (size_t i = 0; i < 1000000; i++) {
